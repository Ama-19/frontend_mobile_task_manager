...
export default function HomeScreen({ navigation }) {
    ...
    const fetchRoutines = async () => {
        try {
            const data = await fetchData('https://ama-backend-rbqv.onrender.com/api/routines');
            setRoutines(data);
        } catch (error) {
    ...
    const fetchTasks = async () => {
        try {
            const data = await fetchData('https://ama-backend-rbqv.onrender.com/api/tasks');
            setTasks(data);
        } catch (error) {
    ...
    const deleteItem = async (type, id) => {
        try {
            await fetchData(`https://ama-backend-rbqv.onrender.com/api/${type}/${id}`, 'DELETE');
